...
import { updateBudget, getBudgetById } from '../../../../BackEnd/db/Tables/budget';
import { getCategoryById } from '../../../../BackEnd/db/Tables/categories';

export const UpdateBudget = ( {route, navigation}) => {
  ...
  useEffect(() => {
    const fetchBudget = async () => {
      try {
        ...
        if (budget) {
          setAmount(budget.cash_limit.toString());
  ...
  const handleUpdateBudget = async () => {
    try {
      await updateBudget(budgetId, startDate.toISOString(), endDate.toISOString(), amount, categoryId);
